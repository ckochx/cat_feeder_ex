defmodule CatFeeder.Turny do
  ...
  # Turny was written using ElixirAle (which was replaced by Circuits.)
  # The Circuits API is slightly different and these function calls will need to be ported.
